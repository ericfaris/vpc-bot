...
ARG DB_PASSWORD
ARG BOT_OWNER
ARG HIGH_SCORE_CHANNEL_NAME
ARG HIGH_SCORE_CHANNEL_ID
...
ENV HIGH_SCORE_CHANNEL_NAME $HIGH_SCORE_CHANNEL_NAME
ENV HIGH_SCORE_CHANNEL_ID $HIGH_SCORE_CHANNEL_ID
